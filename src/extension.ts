...
export function activate(context: vscode.ExtensionContext) {
	...
	const absolutePath = path.join('/home/cnre/workspace/code/cvs-sandbox', 'README');
	workingTree.resourceStates = [{resourceUri: vscode.Uri.file(absolutePath)}];
	...
	let disposable = vscode.commands.registerCommand('cvs-ext.start-cvs', () => {
		// The code you place here will be executed every time your command is executed
		// Display a message box to the user
		vscode.window.showInformationMessage('Starting CVS Extenstion');
	});

	let test = vscode.commands.registerCommand('cvs-ext.test', () => {
		// The code you place here will be executed every time your command is executed
		// Display a message box to the user
