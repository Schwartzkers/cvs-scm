...
export function activate(context: vscode.ExtensionContext) {
	...
	let resurrectLostFile = vscode.commands.registerCommand('cvs-ext.undo-remove2', (resource: vscode.SourceControlResourceState) => {
		console.log(resource.resourceUri);
		cvsSCM.resurrectLostFile(resource.resourceUri);
